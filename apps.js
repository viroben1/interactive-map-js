...
async function getFourSquare(business) {
	...
	let response = await fetch(
		`https://api.foursquare.com/v2/venues/explore?client_id=${clientId}&client_secret=${clentSecret}fsq3n+jy7PEYAqH3hm6EVOICa+AKpmiu5t6gXuC/sVoEKME=${limit}&ll=${lat},${lon}&query=${business}`
	);
